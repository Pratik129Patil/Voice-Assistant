Prior to running code install all libraries and if you face trouble in installing PyAudio library download .whl file for it and install it (PyAudio required for Speech related processes)
